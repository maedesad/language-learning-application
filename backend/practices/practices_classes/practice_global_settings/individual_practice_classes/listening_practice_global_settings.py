...
class ListeningPracticeGlobalSettings(PassivePracticeGlobalSettings):
    """Global settings for Listening practice (inherits from PassivePracticeGlobalSettings)."""

    def get_user_listening_settings(self) -> dict:
    ...
    def set_user_listening_settings(self, data: dict):

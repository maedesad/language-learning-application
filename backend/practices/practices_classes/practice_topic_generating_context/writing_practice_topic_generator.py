...
from backend.practices.practices_classes.practice_global_settings.individual_practice_classes.writing_practice_global_settings import WritingPracticeGlobalSettings
...
class WritingPracticeTopicGenerator(PracticeTopicGenerator, WritingPracticeGlobalSettings):
    def __init__(self, user: User):
        # ------------------- Init parent classes -------------------
        PracticeTopicGenerator.__init__(self, user)
        WritingPracticeGlobalSettings.__init__(self)
    ...
    def set_user_settings_from_user(self, user: User):
        ...
        self.set_paragraphs_number(user.writing_settings.get_paragraphs_number())
        
        # Difficulty level specific for reading
        self.set_difficulty_level(user.writing_settings.get_difficulty_level())
    ...
    def generate_topics(self, mode: str = "suggested") -> dict:   
        ...
        # --- Vocab ---
        if self.vocab_selector.is_enabled():
            vocab_categories = (
